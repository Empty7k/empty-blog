...
function Pessoa() {
  return (
    <div id='bora' className='page-content glass-panel'>
      ...
      <div className="poema-wrapper">
        <div className="poema-container">
          <h2 className="poema-titulo">Se eu morrer novo</h2>
          <div className="poema-texto">
            <p>Se eu morrer novo,</p>
            <p>Sem poder publicar livro nenhum,</p>
            <p>Sem ver a cara que têm os meus versos em letra impressa</p>
            <br />
            <p>Peço que, se se quiserem ralar por minha causa,</p>
            <p>Que não se ralem.</p>
            <p>Se assim aconteceu, assim está certo.</p>
            <br />
            <p>Mesmo que os meus versos nunca sejam impressos,</p>
            <p>Eles lá terão a sua beleza, se forem belos.</p>
            <p>Mas eles não podem ser belos e ficar por imprimir,</p>
            <p>Porque as raízes podem estar debaixo da terra</p>
            <p>Mas as flores florescem ao ar livre e à vista.</p>
            <p>Tem que ser assim por força. Nada o pode impedir.</p>
            <br />
            <p>Se eu morrer muito novo, oiçam isto:</p>
            <p>Nunca fui senão uma criança que brincava.</p>
            <p>Fui gentio como o sol e a água,</p>
            <p>De uma religião universal que só os homens não têm.</p>
            <br />
            <p>Fui feliz porque não pedi coisa nenhuma,</p>
            <p>Nem procurei achar nada,</p>
            <p>Nem achei que houvesse mais explicação</p>
            <p>Que a palavra explicação não ter sentido nenhum.</p>
            <p>Não desejei senão estar ao sol ou à chuva —</p>
            <p>Ao sol quando havia sol</p>
            <p>E à chuva quando estava chovendo</p>
            <p>(E nunca a outra coisa),</p>
            <p>Sentir calor e frio e vento,</p>
            <p>E não ir mais longe.</p>
            <br />
            <p>Uma vez amei, julguei que me amariam,</p>
            <p>Mas não fui amado.</p>
            <p>Não fui amado pela única grande razão —</p>
            <p>Porque não tinha que ser.</p>
            <p>Consolei-me voltando ao sol e à chuva,</p>
            <p>E sentando-me outra vez à porta de casa.</p>
            <br />
            <p>Os campos, afinal, não são tão verdes para os que são amados</p>
            <p>Como para os que o não são.</p>
            <p>Sentir é estar distraído.</p>
            <br />
            <p className="poema-autor">(Alberto Caeiro, 7-11-1915)</p>
          </div>
        </div>
      </div>
      <br />
      ...
      <div className="poema-wrapper">
        <div className="poema-container">
          <h2 className="poema-titulo">Destino</h2>
          <div className="poema-texto"></div>
          <p>Quando está frio no tempo do frio, para mim é como se estivesse agradável,</p>
          <p>Porque para o meu ser adequado à existência das coisas</p>
          <p>O natural é o agradável só por ser natural.</p>
          <p>Aceito as dificuldades da vida porque são o destino,</p>
          <p>Como aceito o frio excessivo no alto do Inverno—</p>
          <p>Calmamente, sem me queixar, como quem meramente aceita,</p>
          <p>E encontra uma alegria no facto de aceitar—</p>
          <p>No facto sublimemente científico e difícil de aceitar o natural inevitável.</p>
          <p>Que são para mim as doenças que tenho e o mal que me acontece</p>
          <p>Senão o Inverno da minha pessoa e da minha vida?</p>
          <p>O Inverno irregular, cujas leis de aparecimento desconheço,</p>
          <p>Mas que existe para mim em virtude da mesma fatalidade sublime,</p>
          <p>Da mesma inevitável exterioridade a mim,</p>
          <p>Que o calor da terra no alto do Verão</p>
          <p>E o frio da terra no cimo do Inverno.</p>
          <p>Aceito por personalidade.</p>
          <p>Nasci sujeito como os outros a erros e a defeitos,</p>
          <p>Mas nunca ao erro de querer compreender demais,</p>
          <p>Nunca ao erro de querer compreender só com a inteligência.</p>
          <p>Nunca ao defeito de exigir do Mundo</p>
          <p>Que fosse qualquer coisa que não fosse o Mundo.</p>
        </div>
      </div>
      <br />
      ...
      <div className="poema-wrapper">
        <div className="poema-container">
          <h2 className="poema-titulo">Tabacaria</h2>
          <div className="poema-texto">
            <p>Não sou nada.</p>
            ...
            <div className="estrofe-divider"></div>
            ...
            <p>Com a morte a pôr umidade nas paredes e cabelos brancos nos homens,</p>
            ...
            <p>Ser o que penso? Mas penso tanta coisa!</p>
            <p>E há tantos que pensam ser a mesma coisa que não pode haver tantos!</p>
            <p>Gênio? Neste momento</p>
            <p>Cem mil cérebros se concebem em sonho gênios como eu,</p>
            ...
            <p>Em todos os manicômios há doidos malucos com tantas certezas!</p>
            <p>Eu, que não tenho nenhuma certeza, sou mais certo ou menos certo?</p>
            <p>Não, nem em mim...</p>
            <p>Em quantas mansardas e não-mansardas do mundo</p>
            <p>Não estão nesta hora gênios-para-si-mesmos sonhando?</p>
            ...
            <p>Serei sempre só <i>o que tinha qualidades;</i></p>
            ...
            <p>O seu sol, a sua chava, o vento que me acha o cabelo,</p>
            <p>E o resto que venha se vier, ou tiver que vir, ou não venha.</p>
            <p>Escravos cardíacos das estrelas,</p>
            <p>Conquistamos todo o mundo antes de nos levantar da cama;</p>
            <p>Mas acordamos e ele é opaco,</p>
            <p>Levantamo-nos e ele é alheio,</p>
            ...
            <p>Mas eu penso e, ao tirar o papel de prata, que é de folha de estanho,</p>
            ...
            <p>A roupa suja que sou, em rol, pra o decurso das coisas,</p>
            ...
            <p>Quem me dera encontrar-me como coisa que eu fizesse,</p>
            ...
            <p>Olho-o com o desconforto da cabeça mal voltada</p>
            <p>E com o desconforto da alma mal-entendendo.</p>
            <p>Ele morrerá e eu morrerei.</p>
            <p>Ele deixará a tabuleta, eu deixarei os versos.</p>
            <p>A certa altura morrerá a tabuleta também, os versos também.</p>
            ...
            <p className="poema-autor">(Álvaro de Campos, 15-1-1928)</p>
          </div>
        </div>
      </div>
